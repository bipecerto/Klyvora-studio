    ...
    <div className="min-h-screen bg-[#0A0A0B] text-[rgba(255,255,255,0.92)] flex items-center justify-center p-5 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white pt-2">Create your account</h1>
          <p className="text-[14px] text-[rgba(255,255,255,0.55)]">
            Start producing automated video series in minutes
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User className="w-4 h-4 text-[rgba(255,255,255,0.4)] absolute left-3.5 top-3.5" />
                <input
                  type="text"
                  value={name}
